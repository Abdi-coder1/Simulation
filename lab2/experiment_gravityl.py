...
The grav is modeled as a attractive force, proportional to the ditance between partiucles radius
In order to see clearly, one of the particles will be highlighted with color and a vel vector.

The model behaves as expected, however it does often go towards a form of cahos. When the
particles gets to close or the G cinstant is to large, their veolicties increase to the point
